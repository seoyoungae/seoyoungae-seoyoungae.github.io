...
const quiz = [{"q":"배달 앱 속 나의 등급은?",
        ...
        "a":["당분간은 계속 집에 있어야 하는데.. 먹을 간식과 생필품을 구입한다.","나는.. 아무 생각이 없다.<br>왜냐면 아무 생각이 없기 때문이다","휴 이렇게 집에만 있으니 좀 그렇다.라고 생각하며 당장 뭘 배워야 할지 찾아보고 상담예약을 잡아본다."]},
    {"q":"약속 시간 전 당신의 모습은?",
"a":["약속 2시간 전부터 일어나서 준비중이지만 세월아 네월아 한다.","아 귀찮다.. 나가지말까.. 하고 늘어져 있다가 시간을 보고 재빨리 준비한다.","옷은 전날에 미리 골라놨으니<br>메이크업, 헤어 등 섬세하게 꾸민다"]},
{"q":"친구들과의 약속이 있을 때 나의 모습은?",
"a":["10분 전에 미리 도착해 친구들을 기다린다.","조금 늦는다고 연락하고<br>친구들이 다 모였을 때 그 장소로 간다.","진짜 되도록 안 나가지만<br> 굳이 약속이 있다면 정각에 도착한다."]},{
"q":"주말에 만나자는 친구!<br>하지만 집밖은 위험해!<br>나의 대답은?",
"a":["귀찮지만 뭐하는지에 따라 결정한다","귀찮은건 절대 NO!<br>약속있는척하고 안나간다","그래도 친구가 오랜만에 만나자니 나간다"]},
{"q":"아무 약속이 없는 주말, 뭐할까?",
"a":["밥먹고 세수와 양치만 하고<br>쇼파에 앉아 티비를 본다", "안씻고 누워서 넷플릭스나 왓챠를 켜본다.","밥 먹고 샤워를 한 뒤<br>밀린 방 청소나 할 일을 찾아 움직인다."]},{
    "q":"나에게 소확행이란?","a":["남자친구와 주말에 걸어다니면서<br>소소한 데이트하기","행복이란<br>'내침대에서 따듯한 전기장판과<br>부드러운 극세사 이불을 덮고<br> 귤을 까먹으며 밀린 드라마를 보는것'...","친구들이랑 다 같이 모여서<br>캠핑이나 1박 여행을 간다"]
},{
    "q":"갑자기 일이 생겨서 못 만난다고 하는 친구!","a":[,"밖에 있으면 누구라도 나오겠지. 카페나 pc방에서 친구들을 부른다","안타까워 하는척하면서 집에서 쉴 생각에 기분이 좋아진다.","아.. 어쩔수 없지 하면서 바로 다른친구에게 전화를 건다"]
},{
